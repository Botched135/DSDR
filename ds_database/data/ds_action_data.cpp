...
namespace DSDR
{
    ...
    struct ActionEntry
    {
        ...
        Action::Range m_range;
        Action::Targeting m_targeting;
        Action::Type m_type = Action::Type::Main;
        std::string m_trigger;
        std::vector<Action::Outcome> m_outcomes;
        std::string m_special;
        Action::MaliceCost m_malice_cost;
        std::vector<Action::Effect> m_additional_effects;
        Action::Cooldown m_cooldown;
