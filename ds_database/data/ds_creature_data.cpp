...
namespace DSDR
{
    ...
    struct MonsterEntry
    {
        ...
        i16 m_death = 0;
        u16 m_level = 1;
        Creature::Size m_size;
        u16 m_speed;
        u16 m_stability;
        u16 m_stamina;
        u16 m_free_strike;
        std::string m_captain_bonus;
        Creature::resilience_array m_resilience;
        Creature::Characteristics m_characteristics;
        ...
        std::vector<Creature::Trait> m_traits;
    };
}