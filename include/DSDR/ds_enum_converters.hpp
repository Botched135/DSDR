...
namespace DSDR
{
    ...
    namespace
    {
        ...
        static enum_map<Creature::Movement> movement_map;
        static enum_map<Creature::KeywordFlags> creature_keyword_map;
        static enum_map<Creature::Size> size_map;
    ...
    void initilize_enum_maps()
    {
        ...
        // Movement
        movement_map["none"]     = Creature::Movement::None;
        movement_map["burrow"]   = Creature::Movement::Burrow;
        movement_map["climb"]    = Creature::Movement::Climb;
        movement_map["flying"]   = Creature::Movement::Flying;
        movement_map["hover"]    = Creature::Movement::Hover;
        movement_map["swim"]     = Creature::Movement::Swim;
        movement_map["teleport"] = Creature::Movement::Teleport;
